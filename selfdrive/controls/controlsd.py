...
AWARENESS_TIME = 1200.      # 20 minutes limit without user touching steering wheels
AWARENESS_PRE_TIME = 40.   # a first alert is issued 40s before start decelerating the car
